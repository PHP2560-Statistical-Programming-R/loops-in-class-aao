...
hand="FullHouse"}else if ((x[1]+1==x[2]&x[2]+1==x[3]&x[3]+1==x[4]&x[4]+1!=x[5])|(x[1]+1!=x[2]&x[2]+1==x[3]&x[3]+1==x[4]&x[4]+1==x[5])|x[1]){
hand="smallstraight"
...
hand <- function(k) {
  if(k[1]==k[5]) {
    ...
    hand <- "LargeStraight"
  } else if(sum(k[2]-k[1]==1,k[3]-k[2]==1,k[4]-k[3]==1,k[5]-k[4]==1)==3) {
    hand <- "SmallStraight"
  } else {
    hand <- "Chance"
  }
