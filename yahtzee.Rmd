...
hand <- function(k) {
  if(k[1]==k[5]) {
    ...
    hand <- "LargeStraight"
  } else if((k[2]==x[1]+1 & k[3]==k[2]+1 & k[4]==k[3]+1) | (k[3]==k[2]+1 & k[4]==k[3]+1 & k[5]==k[4]+1)) {
    # | x == c(1,2,2,3,4) | x == c(1,2,3,3,4) | x == c(2,3,3,4,5) | x == c(2,3,4,4,5) | x == c(3,4,4,5,6) | x == c(3,4,5,5,6) 
    hand <- "SmallStraight"
  } else {
    hand <- "Chance"
  }
